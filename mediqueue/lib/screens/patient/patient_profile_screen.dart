...
//                     ),
//                     title:
//                         Text(visit['title']?.toString() ?? 'Consultation'),
//                     subtitle: Text(
//                       "${visit['doctor']?.toString() ?? 'Doctor'}\n${visit['date']?.toString() ?? 'Recent'}",
//                     ),
//                     isThreeLine: true,
//                   ),
//                   if (index < _recentVisits.length - 1)
//                     const Divider(),
//                 ],
//               );
//             }).toList()
...
import '../common/history_screen.dart' show HistoryScreen; // Add this import
...
// Replace the existing _navigateToHistoryScreen method with this:
// In PatientProfileScreen class, update the navigation method:
void _navigateToHistoryScreen() {
  Navigator.push(
    context,
    MaterialPageRoute(
      builder: (context) => HistoryScreen(
        visit: {}, visits: [], // Pass an empty map to satisfy the constructor
      ),
    ),
  );
}
